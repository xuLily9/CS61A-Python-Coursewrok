...
class Place(object):
    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                elif insect.can_contain(self.ant) and insect.is_container:
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if hasattr(insect, 'is_queen') and insect.is_queen:
                return
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while place != hive:
            ...
            if random_or_none(place.bees) != None and self.min_range <= count <= self.max_range:
...
class HungryAnt(Ant):
    ...
    def action(self, colony):
        ...
        if self.digesting > 0:
            self.digesting -= 1
        if self.digesting == 0 and random_or_none(self.place.bees) != None:
...
class TankAnt(BodyguardAnt):
    ...
    def __init__(self):
        BodyguardAnt.__init__(self, armor=2)
