...
def taxicab(a, b):
    ...
    """
    "*** YOUR CODE HERE ***"
    one_str, one_ave = street(a), avenue(a)
    two_str, two_ave = street(b), avenue(b)

    return abs(one_str - two_str) + abs(one_ave - two_ave)
...
def replace_leaf(t, old, new):
    ...
    if is_leaf(t):
        ...
        new_tree = [replace_leaf(i, old, new) for i in branches(t)]
...
def totals_tree(m):
    ...
    if is_weight(m):
        ...
        return tree(label,[totals_tree(end(left(m))),totals_tree(end(right(m)))])
