...
def is_swap(player_score, opponent_score):
    ...
    if player_score>=100:
        a = player_score//100
    elif player_score<100 and player_score>=10:
        a = player_score//10
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    def say(score0, score1, p_high=previous_high, p_score=previous_score):
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while k <= 10:
        ...
        max_score_i = averaged_roll_dice(k, dice)
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    update_score = free_bacon(opponent_score) + score  # The score after roll 0
    # if is_swap(update_score, opponent_score):
    #     opponent_score, update_score = update_score, opponent_score
    if update_score <= opponent_score and is_swap(update_score, opponent_score):
        return 0
    elif free_bacon(opponent_score) >= margin:
        if not is_swap(update_score, opponent_score):
            return 0
        else:
            if update_score <= opponent_score:
                return 0
    return num_rolls
